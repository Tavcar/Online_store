...
class User(ndb.Model):
    ...
    @classmethod
    def create(cls, email, full_name, address_line_1, address_line_2, city, state, zip_number, country):
        user = cls(email=email, full_name=full_name, address_line_1=address_line_1,
